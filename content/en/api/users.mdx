...
Root users can manage all users within their account, including creating, updating, and deleting other users. Regular users can only manage their own profile.
