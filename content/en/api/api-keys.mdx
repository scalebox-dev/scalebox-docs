...
<Callout type="info">
**Secret handling:** the full `api_key` secret is returned on create and get, but list/update responses only expose the display prefix.
</Callout>
...
| limit | integer | No | SQL limit |
| offset | integer | No | SQL offset |
