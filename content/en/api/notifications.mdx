...
description: Complete API reference for managing notifications. Stay informed about important events, system status changes, and resource alerts in your ScaleBox account.
icon: Bell
---
